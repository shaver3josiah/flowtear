...
struct AboutView: View {
    ...
    private let faqs: [(q: String, a: String)] = [
        ...
        ("How do petal points work?",
         "Every stretch pose you check earns 15, chains earn +5, a finished day +10, and first-time guided poses +30 — multiplied by your plan (trio ×1, 3-day ×2, 14-day ×4). Spend them in the garden shop. The full rules live behind the book icon in Stretch."),
