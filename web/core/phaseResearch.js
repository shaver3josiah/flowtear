// PhaseResearch — a verbatim port of App/Core/PhaseResearch.swift: a short,
// research-grounded report for each experience the cycle brings, written warm
// and plain. Every report was drafted against the published evidence
// (systematic reviews, RCTs, physiology references) and then adversarially
// reviewed for over-claiming, medical-advice framing, and tone before landing
// here. Population claims stay hedged; nothing diagnoses; fertility info is
// never framed as contraception (see the product guardrails).
//
// Pure module: no DOM, no window, no storage. Each report is
// { title, body, tips, evidenceNote }.
...
export const menstrual = {
  ...
  tips: [
    "Try a heating pad — steady low heat is well studied for cramps.",
...
export const follicular = {
  ...
  tips: [
    "Front-load planning, launches, and big decisions this week.",
...
export const ovulation = {
  ...
  tips: [
    "Clear, egg-white mucus signals your most fertile days.",
    ...
    "Lean into higher energy — plan social things now.",
  ],
...
export const premenstrual = {
  ...
  tips: [
    "Try a slow 10-minute stretch or yoga flow.",
...
export const stretching = {
  ...
  tips: [
    "Try 10 minutes of gentle stretching most days.",
...
/// The report for a cycle position. The last week before the period gets its
/// own premenstrual report — that experience is distinct from the early-luteal
/// calm, and it's the one she's most likely to look up.
/// (PhaseResearch.swift:20)
export function report(phase, day, cycleLength) {
  switch (phase) {
